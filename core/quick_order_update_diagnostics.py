...
def _format_automation_section(automation: dict) -> list:
    ...
    lines.append(f"  Visual OCR Marker Band: {automation.get('visual_ocr_marker_band', 'N/A')}")
    lines.append(f"  Visual OCR Text Band : {automation.get('visual_ocr_text_band', 'N/A')}")
    lines.append(f"  Visual OCR Click Band: {automation.get('visual_ocr_click_band', 'N/A')}")
    lines.append(f"  Visual OCR Click Source: {automation.get('visual_ocr_click_source', 'N/A')}")
    lines.append(f"  Visual OCR Align Offset: {automation.get('visual_ocr_align_offset', 'N/A')}")
    ...
    lines.append(f"  Visual OCR Off Source: {automation.get('visual_ocr_offset_source', 'generic_fallback')}")
