...
class ControlWindow:
    ...
    def _on_scan_chars(self):
        try:
            ...
            logger.error(f"scan_chars error: {e}", exc_info=True)
    ...
    def _update_status(self):
        ...
        try:
            ...
            logger.warning(f"_update_status error: {e}")
        ...
        try:
            ...
            logger.debug(f"replicator_min check: {e}")
        ...
        try:
            ...
            logger.debug(f"hud_docked check: {e}")
        ...
        try:
            ...
            logger.debug(f"repl_docked check: {e}")
        ...
        try:
            ...
            logger.debug(f"trans_docked check: {e}")
