...
class AuthManager(QObject):
    ...
    def __init__(self):
        super().__init__()
        self.client_id = "70c345f8f94d4d8096f2e9678125439b" # Placeholder - Needs to be set by user or dev
        self.redirect_uri = "http://localhost:12543/callback"
        self.scopes = "esi-ui.open_window.v1"
    ...
    def login(self):
        ...
        if not self.client_id or self.client_id == "YOUR_CLIENT_ID":
            print("AuthManager: No Client ID configured.")
            return False
        ...
        def run_server():
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                ...
                try:
                    ...
                    print("AuthManager: Login timeout.")
                except Exception as e:
                    print(f"AuthManager: Server error: {e}")
